...
public class messageScreen extends AppCompatActivity {
    ...
    public class getTheirKeys extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            try{
                Socket socket = new Socket("192.168.0.103", 25000);
                secretKeySpec = "Bar12345Bar12345";
        ...
        protected Void doInBackground(Void... voids) {
            try{
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(messageScreen.this,"secretkey: "+Base64.encodeToString(secretKey,Base64.DEFAULT|Base64.NO_WRAP)+" has been generated!",Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        try{
            ...
            if ((input = bufferedReader.readLine()).equals("8")){
                ...
                if (bufferedReader.readLine().equals("8.1")){
                    ...
                    System.out.println("encryptedbytes have been sent to server");
                }
            }
        }
        catch (Exception e){
